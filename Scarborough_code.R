...
# read in excel data
raw_data = read.csv("Scarborough_North_sp.csv")
...
####################################################
# save outputs as csv
write.csv(geomean_output, file = "Scarborough_geomeans.csv")
write.csv(annual_by_month_output, file = "Scarborough_annual_by_month.csv")
write.csv(annual_geomean_output, file = "Scarborough_annual_geomean.csv")
write.csv(mk_output, file = "Scarborough_mk.csv")
